...
// --- ২. একক কার্ড কম্পোনেন্ট (Master Design V2) ---
const TransactionCard = ({ e, onEdit, onDelete, onToggleStatus, currencySymbol }: any) => {
    ...
    return (
        ...
        >
            ...
            {/* 2. Middle Body: Title & Inline Note (Position 1 Refactoring) */}
            <div className="flex justify-between items-start gap-4">
                <div className="flex-1 min-w-0">
                    ...
                    {/* Inline Note (Styled exactly like old REF) */}
