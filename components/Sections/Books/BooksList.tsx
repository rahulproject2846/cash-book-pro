...
const BooksList = ({ 
    ...
    const { filteredBooks, activeBook, getBookBalance, searchQuery, isMobile, books, sortOption } = useVaultStore();
        ...
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-10 mt-2 md:mt-6 md:px-8 lg:px-10">
                ...
                <AnimatePresence>
                    ...
                    {!activeBook && (!isMobile || books.length === 0) && (
                    ...
                    {filteredBooks?.map((b: any, index: number) => {
                        ...
                        return (
                            ...
                            <BookCard 
                                ...
                                key={`${bookKey}-${searchQuery?.length || 0}-${sortOption || 'Activity'}`}
